...
const KNOWN_PARALLELS: string[] = [
  ...
  'Light Blue Sparkle', 'Silver Sparkle', 'Pink Sparkle', 'Burgundy Sparkle', 'Aqua Sparkle',
  'Blue Bordered', 'Green Bordered', 'Black Bordered', 'Gold Bordered', 'Orange Bordered', 'Red Bordered',
  'Dark Gray Bordered', 'Dark Green Bordered', 'Light Purple Bordered', 'Dark Yellow Bordered', 'Deckle Edge', 'Heritage Orange', 'Flip Stock',
  ...
  'Teal', 'White', 'Yellow', 'Rainbow Foil', 'Gold Foil', 'Yellow Foil', 'Royal Blue',
  'Blue Holofoil', 'Purple Holofoil', 'Green Crackle', 'Orange Crackle', 'Red Crackle',
  'Vintage Stock', 'Independence Day', "Father's Day Powder Blue", "Mother's Day Hot Pink",
  'Memorial Day Camo', 'Clear', 'Platinum', 'First Edition',
  'Confetti', 'Confetti Red', 'Confetti Blue', 'Confetti Green',
