    ...
    <div className="bg-amber-950/30 border border-amber-700/50 rounded-xl p-5">
      ...
      <div className="space-y-3">
        {items.map(item => {
          ...
          return (
            <div key={item.id} className="flex items-center gap-4 bg-zinc-900/60 border border-zinc-800 rounded-lg p-3">
              {item.image_url ? (
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white px-4 py-2 rounded-lg text-xs font-black flex items-center gap-1.5 transition-colors"
                >
                ...
                <button
                  ...
                  className="bg-zinc-700 hover:bg-zinc-600 text-zinc-300 px-3 py-2 rounded-lg text-xs font-bold flex items-center gap-1 transition-colors"
